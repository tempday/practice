 ...
 */
Function.prototype.bind || (Function.prototype.bind = function(e) { if ("function" != typeof this) throw new TypeError("Function.prototype.bind"); var t = Array.prototype.slice.call(arguments, 1),s = this,n = function() {},i = function() { return s.apply(this instanceof n && e ? this : e, t.concat(Array.prototype.slice.call(arguments))) }; return n.prototype = this.prototype, i.prototype = new n, i });
+function(){
	//设置同人专区的图片和文字
	...
	//兼容ie789,波浪背景动画
	function WaveBg(bg,mTime){
		this.bg=$(bg);//$();
		this.mTime=mTime;
	}
	WaveBg.prototype.move=function(){
		this.bg.animate({'left':-1284},this.mTime,'linear',function(){
			this.bg.css({left:0});
			this.move();
		}.bind(this));
	};
	if(/msie\s*[789]\.0/i.test(navigator.userAgent)){
		new WaveBg('.wave .bg1',6000).move();
		new WaveBg('.wave .bg2',8000).move();
		new WaveBg('.wave .bg3',4000).move();
	}
